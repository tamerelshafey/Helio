        ...
        <div className="py-20 bg-white dark:bg-gray-900">
            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">{t.contactPage.title}</h1>
                    <p className="text-lg text-gray-500 dark:text-gray-400 mt-4 max-w-2xl mx-auto">{t.contactPage.subtitle}</p>
                </div>
                <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 bg-gray-50 dark:bg-gray-800 p-8 rounded-lg border border-gray-200 dark:border-gray-700">
                    <div>
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{t.contactPage.inquiryTypeLabel}</label>
                                <div className="flex gap-4 p-1 bg-gray-200 dark:bg-gray-700 rounded-lg">
                                    <button type="button" onClick={() => handleInquiryTypeChange('client')} className={`w-full py-2 rounded-md transition-colors ${inquiryType === 'client' ? 'bg-white dark:bg-gray-800 shadow text-amber-600 font-semibold' : 'text-gray-600 dark:text-gray-300'}`}>{t.contactPage.clientOption}</button>
                                    <button type="button" onClick={() => handleInquiryTypeChange('partner')} className={`w-full py-2 rounded-md transition-colors ${inquiryType === 'partner' ? 'bg-white dark:bg-gray-800 shadow text-amber-600 font-semibold' : 'text-gray-600 dark:text-gray-300'}`}>{t.contactPage.partnerOption}</button>
                                </div>
                            </div>
                                ...
                                <div className="space-y-6 p-4 border border-amber-500/20 rounded-lg animate-fadeIn">
                                    ...
                                    <div>
                                        <label htmlFor="businessType" className="sr-only">{t.contactPage.businessTypeLabel}</label>
                                         <Select id="businessType" {...register("businessType", { required: inquiryType === 'partner' })} className={!watch('businessType') ? 'text-gray-500 dark:text-gray-400' : ''} >
                                            <option value="" disabled>{t.contactPage.businessTypeLabel}</option>
                                            <option value="developer" className="text-gray-900 dark:text-white">{t.contactPage.developerOption}</option>
                                            <option value="finishing" className="text-gray-900 dark:text-white">{t.contactPage.finishingOption}</option>
                                            <option value="agency" className="text-gray-900 dark:text-white">{t.contactPage.agencyOption}</option>
                                        </Select>
                                    </div>
                                </div>
                            )}
                            ...
                            <div>
                                ...
                                <Select id="contactTime" {...register("contactTime", { required: true })} className={!watch('contactTime') ? 'text-gray-500 dark:text-gray-400' : ''}>
                                    <option value="" disabled>{t.contactPage.contactTimeDefault}</option>
                                    <option value="morning" className="text-gray-900 dark:text-white">{t.contactPage.contactTimeMorning}</option>
                                    <option value="afternoon" className="text-gray-900 dark:text-white">{t.contactPage.contactTimeAfternoon}</option>
                                    <option value="evening" className="text-gray-900 dark:text-white">{t.contactPage.contactTimeEvening}</option>
                                </Select>
                            </div>
                            <div>
                        ...
                        {isLoadingContent ? <div className="animate-pulse space-y-4"><div className="h-6 bg-gray-200 dark:bg-gray-700 rounded w-3/4"></div><div className="h-6 bg-gray-200 dark:bg-gray-700 rounded w-1/2"></div></div> : (
                            <>
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-gray-900 dark:text-white">{t.contactPage.addressTitle}</h3>
                                ...
                                <div className="flex items-start gap-4">
                                    <span className="text-amber-500 mt-1">📞</span>
                                    <div>
                                        <h3 className="font-semibold text-gray-900 dark:text-white">{t.contactPage.phoneTitle}</h3>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-gray-900 dark:text-white">{t.contactPage.emailTitle}</h3>
                                ...
                                <div className="flex items-start gap-4">
                                    <span className="text-amber-500 mt-1">⏰</span>
                                    <div>
                                        <h3 className="font-semibold text-gray-900 dark:text-white">{t.contactPage.hoursTitle}</h3>
