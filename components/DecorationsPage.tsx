...
const DecorationsPage: React.FC = () => {
    ...
    const { data: allWorks, isLoading: isLoadingWorks } = useQuery({ queryKey: ['allPortfolioItems'], queryFn: getAllPortfolioItems });
    const { data: decorationCategories, isLoading: isLoadingCats } = useQuery({ queryKey: ['decorationCategories'], queryFn: getDecorationCategories });
