            ...
            <div className="container mx-auto px-6">
                <div className="flex justify-between items-center h-16 lg:h-20">
                    ...
                    <div className="flex items-center gap-2 md:gap-4">
                        ...
                        <Link
                            to="/favorites"
                            className="hidden lg:block text-gray-500 dark:text-gray-400 hover:text-amber-500 transition-colors"
                        ...
                        <div className="hidden lg:flex items-center gap-2 border-l border-gray-200 dark:border-gray-700 pl-4">
                            {currentUser ? (
                                <>
                                    <Link
                                        to={dashboardPath}
                                        className="text-gray-700 dark:text-gray-200 font-semibold hover:text-amber-500 transition-colors"
                                    >
                                        {dashboardText}
                                    </Link>
                                    <button
