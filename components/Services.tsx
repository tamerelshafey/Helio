...
const ServiceCard: React.FC<{ icon: React.ReactNode; title: string; description: string; link: string }> = ({
    ...
    <Link to={link} className="block group h-full">
        <Card className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm h-full transform hover:-translate-y-2 transition-transform duration-300 hover:border-amber-500/50 hover:shadow-2xl hover:shadow-amber-500/10 p-0 card-glow">
        ...
        <section className="py-20 bg-gray-50 dark:bg-gray-800 subtle-bg">
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-500 dark:text-gray-400 mt-4 max-w-3xl mx-auto">{t.description}</p>
                </div>
