...
const ProjectListItemSkeleton: React.FC = () => {
    return (
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm overflow-hidden flex h-full animate-pulse">
            <div className="w-28 md:w-48 flex-shrink-0 bg-gray-200 dark:bg-gray-700"></div>
            <div className="p-3 md:p-4 flex flex-col flex-grow w-full">
                <div className="h-5 md:h-6 w-3/4 bg-gray-200 dark:bg-gray-700 rounded mb-2"></div>
                ...
                <div className="h-3 w-5/6 bg-gray-200 dark:bg-gray-700 rounded mb-auto"></div>
