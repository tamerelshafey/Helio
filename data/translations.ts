export const translations = {
    ar: {
        ...
        partnerInfo: {
            ...
            'admin-user': { name: 'المدير العام', description: 'مدير المنصة' },
            'finishing-manager-1': { name: 'مدير التشطيبات', description: 'مسؤول عن طلبات التشطيبات' },
            'decorations-manager-1': { name: 'مدير الديكورات', description: 'مسؤول عن طلبات وأعمال الديكور' },
            'listings-manager-1': { name: 'مدير العقارات والطلبات', description: 'مسؤول عن العقارات وطلبات العملاء' },
            'partner-relations-manager-1': { name: 'مدير علاقات الشركاء', description: 'مسؤول عن الشركاء وطلبات الانضمام' },
            'content-manager-1': { name: 'مدير المحتوى', description: 'مسؤول عن محتوى الموقع والإعلانات' },
            'individual-listings': { name: 'ملاك أفراد', description: 'عقارات معروضة مباشرة من الملاك.' },
        },
        partners: {
            title: 'شركاء النجاح',
            description: 'مسيرتنا نحو التميز مبنية على الثقة والتعاون مع نخبة من أفضل الشركات في مختلف المجالات.',
            mega_projects_title: 'عمالقة التطوير العقاري',
        ...
        addPropertyPage: {
            ...
            cooperation: {
                ...
                paid_listing: {
                    ...
                    description: "أضف عقارك على منصتنا لمدة محددة مقابل رسوم ثابتة. ستتلقى استفسارات المهتمين مباشرة وتتولى عملية التفاوض والبيع بنفسك.",
        ...
        adminDashboard: {
            ...
            nav: {
                ...
                listedProperties: 'العقارات المعروضة',
                propertyInquiries: 'طلبات البحث عن عقار',
                ...
                manageProjects: 'إدارة كل المشاريع',
                manageLeads: 'إدارة كل الطلبات',
                managePlans: 'إدارة الباقات',
                manageFilters: 'إدارة الفلاتر',
                manageDecorations: 'محتوى الديكورات',
                decorationsPortfolio: 'أعمال الديكور',
                decorationsRequests: 'طلبات الديكور',
                decorationsCategories: 'أقسام الديكور',
                manageBanners: 'إدارة الإعلانات',
                contentManagement: 'إدارة المحتوى',
                settings: 'الإعدادات',
                serviceLeads: 'طلبات الخدمات',
                finishingRequests: 'طلبات التشطيبات',
            },
            finishingRequests: {
                manage: 'إدارة',
                assignedTo: 'مسند إلى',
            ...
            partnerTypes: {
                ...
                agency: 'مكتب عقاري',
                admin: 'مسؤول عام',
                finishing_manager: 'مدير تشطيبات',
                decorations_manager: 'مدير ديكورات',
                listings_manager: 'مدير عقارات',
                partner_relations_manager: 'مدير شركاء',
        ...
        privacyPolicyPage: {
            ...
            introduction: {
                title: "مقدمة",
                content: "تحترم منصة ONLY HELIO خصوصيتك وتلتزم بحماية بياناتك الشخصية. توضح سياسة الخصوصية هذه كيف نجمع معلوماتك الشخصية ونستخدمها ونحميها عند استخدامك لموقعنا وخدماتنا.",
            },
            dataCollection: {
                title: "المعلومات التي نجمعها",
                content: "قد نجمع أنواعًا مختلفة من المعلومات منك، بما في ذلك:\n- البيانات الشخصية: مثل اسمك ورقم هاتفك وبريدك الإلكتروني عند تقديم طلب أو التسجيل كشريك.\n- بيانات الاستخدام: معلومات حول كيفية وصولك إلى الخدمة واستخدامها، مثل عنوان IP الخاص بك ونوع المتصفح والصفحات التي تمت زيارتها.\n- ملفات تعريف الارتباط (الكوكيز): نستخدم ملفات تعريف الارتباط لتتبع النشاط على خدمتنا والاحتفاظ بمعلومات معينة.",
            },
            dataUsage: {
                title: "كيف نستخدم معلوماتك",
                content: "نستخدم البيانات التي نجمعها لأغراض مختلفة:\n- لتوفير خدماتنا وصيانتها.\n- لإدارة حسابك وتسهيل التواصل معك.\n- لإعلامك بالتغييرات التي تطرأ على خدماتنا.\n- لتحليل الاستخدام وتحسين منصتنا.\n- لتوصيل طلباتك إلى الشركاء المعنيين.",
            },
            dataSharing: {
                title: "مشاركة معلوماتك",
                content: "قد نشارك معلوماتك الشخصية في الحالات التالية:\n- مع مقدمي الخدمات: لمساعدتنا في تشغيل خدمتنا.\n- مع الشركاء: عند تقديم طلب خدمة، تتم مشاركة معلومات الاتصال الخاصة بك مع الشريك المعني لتمكينه من التواصل معك.\n- للامتثال القانوني: إذا طُلب منا ذلك بموجب القانون.",
            },
            security: {
                title: "أمن بياناتك",
                content: "أمن بياناتك مهم بالنسبة لنا، لكن تذكر أنه لا توجد وسيلة نقل عبر الإنترنت أو طريقة تخزين إلكتروني آمنة 100%. بينما نسعى جاهدين لاستخدام وسائل مقبولة تجاريًا لحماية بياناتك الشخصية، لا يمكننا ضمان أمنها المطلق.",
            },
            changes: {
                title: "التغييرات على سياسة الخصوصية",
                content: "قد نقوم بتحديث سياسة الخصوصية الخاصة بنا من وقت لآخر. سنعلمك بأي تغييرات عن طريق نشر سياسة الخصوصية الجديدة على هذه الصفحة.",
            },
            contact: {
                title: "تواصل معنا",
                content: "إذا كان لديك أي أسئلة حول سياسة الخصوصية هذه، يمكنك الاتصال بنا عبر صفحة 'تواصل معنا'.",
            },
        },
        termsOfUsePage: {
            ...
            agreement: {
                ...
                content: "باستخدامك لمنصة ONLY HELIO، فإنك توافق على الالتزام بشروط الاستخدام هذه. إذا كنت لا توافق على هذه الشروط، فالرجاء عدم استخدام المنصة.",
            },
            serviceDescription: {
                title: "وصف الخدمة",
                content: "ONLY HELIO هي منصة إلكترونية متخصصة في عرض العقارات والخدمات المتعلقة بها (مثل التشطيب والديكور) في مدينة هليوبوليس الجديدة. نحن نعمل كحلقة وصل بين العملاء ومقدمي الخدمات (الشركاء).",
            },
            userAccounts: {
                title: "حسابات المستخدمين والشركاء",
                content: "يتحمل الشركاء مسؤولية الحفاظ على سرية معلومات حساباتهم. يجب تقديم معلومات دقيقة وكاملة عند التسجيل. نحتفظ بالحق في تعليق أو إنهاء الحسابات التي تنتهك هذه الشروط.",
            },
            prohibited: {
                title: "الأنشطة المحظورة",
                content: "لا يجوز لك استخدام المنصة لأي غرض غير قانوني أو محظور. يشمل ذلك، على سبيل المثال لا الحصر، نشر محتوى مضلل أو احتيالي، أو انتهاك حقوق الملكية الفكرية، أو استخدام المنصة بطريقة قد تضر بها.",
            },
            intellectualProperty: {
                title: "حقوق الملكية الفكرية",
                content: "المنصة وجميع محتوياتها وميزاتها ووظائفها مملوكة لـ ONLY HELIO وهي محمية بموجب قوانين حقوق النشر والعلامات التجارية الدولية.",
            },
            disclaimer: {
                title: "إخلاء المسؤولية",
                content: "يتم توفير الخدمة 'كما هي'. نحن لا نضمن دقة أو اكتمال أو موثوقية أي معلومات على المنصة. أنت توافق على أن استخدامك للمنصة على مسؤوليتك الخاصة.",
            },
            limitation: {
                title: "تحديد المسؤولية",
                content: "لن تكون ONLY HELIO مسؤولة عن أي أضرار غير مباشرة أو عرضية أو خاصة تنشأ عن أو فيما يتعلق باستخدامك للمنصة.",
            },
            governingLaw: {
                title: "القانون الحاكم",
                content: "تخضع هذه الشروط وتُفسر وفقًا لقوانين جمهورية مصر العربية.",
            },
            contact: {
                title: "تواصل معنا",
                content: "إذا كان لديك أي أسئلة حول شروط الاستخدام هذه، يمكنك الاتصال بنا عبر صفحة 'تواصل معنا'.",
            },
        },
    },
    en: {
        ...
        partnerInfo: {
            ...
            'admin-user': { name: 'Admin User', description: 'Platform Administrator' },
            'finishing-manager-1': { name: 'Finishing Manager', description: 'Responsible for finishing requests.' },
            'decorations-manager-1': { name: 'Decorations Manager', description: 'Responsible for decoration works and requests.' },
            'listings-manager-1': { name: 'Listings & Requests Manager', description: 'Responsible for properties and customer requests.' },
            'partner-relations-manager-1': { name: 'Partner Relations Manager', description: 'Responsible for partners and join requests.' },
            'content-manager-1': { name: 'Content Manager', description: 'Responsible for website content and banners.' },
        ...
        partners: {
            ...
            mega_projects_title: 'Mega Project Developers',
        ...
        addPropertyPage: {
            ...
            cooperation: {
                ...
                paid_listing: {
                    ...
                    description: "List your property on our platform for a fixed fee and period. You'll receive inquiries directly and handle negotiations and the sale process yourself.",
        ...
        adminDashboard: {
            ...
            nav: {
                ...
                manageDecorations: 'Decorations Content',
            ...
            partnerTypes: {
                ...
                decorations_manager: 'Decorations Manager',
        ...
        adminAnalytics: {
            ...
            leads: 'Leads',
            topPerformingProperties: 'Top Properties by Leads',
            topPerformingPartners: 'Top Partners by Leads',
            conversionRate: 'Conversion Rate',
            leadsPerProperty: 'Leads / Property',
        ...
        adminReports: {
            ...
            subtitle: 'Create and export custom reports based on platform data.',
        ...
        subscriptionPlans: {
            ...
            developer: {
                ...
                professional: {
                    name: "Professional",
                    price: "EGP 799 / month",
                    description: "For growing companies looking to showcase multiple projects.",
                    features: [
                ...
                elite: {
                    name: "Elite",
                    price: "EGP 1499 / month",
                    description: "For large firms seeking maximum exposure and benefits.",
                    features: [
                        "Unlimited projects",
                        "Unlimited units",
            ...
            agency: {
                basic: {
                    name: "Basic",
                    price: "Free",
                    description: "Perfect for getting started and listing a few properties.",
                    features: [
                ...
                professional: {
                    name: "Professional",
                    price: "EGP 499 / month",
                    description: "For growing partners who want more visibility.",
                    features: [
                ...
                elite: {
                    name: "Elite",
                    price: "EGP 999 / month",
                    description: "For top firms seeking maximum exposure.",
                    features: [
            ...
            finishing: {
                commission: {
                    ...
                    price: "Symbolic Fee + 10% Commission",
                    description: "Start without a big commitment. We bring you the clients, and we share in the success.",
                    features: [
                        "Basic partner profile",
                        "Portfolio (10 items)",
                        "Receive leads through the platform",
                        "Basic support",
                    ],
                    commissionRate: 10,
                },
                professional: {
                    ...
                    price: "EGP 499 / month",
                    description: "For companies wanting to enhance their presence and get direct leads with no commission.",
                    features: [
                        "Everything in Commission Plan, plus:",
                        "'Featured Partner' badge",
                        "Priority placement on Finishing page",
                        "Larger Portfolio (50 items)",
                ...
                elite: {
                    ...
                    features: [
                        ...
                        "'Elite Partner' badge",
                        "Prominent placement in featured spots",
        ...
        upgradePlanModal: {
            title: "Limit Reached",
            message: "You have reached the maximum number of properties for your current plan. Please upgrade your plan to add more.",
            closeButton: "Close",
        ...
        privacyPolicyPage: {
            ...
            introduction: {
                title: "Introduction",
                content: "The ONLY HELIO platform respects your privacy and is committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website and use our services.",
            },
            dataCollection: {
                title: "The Data We Collect About You",
                content: "We may collect different kinds of information from you, including:\n- Personal Data: such as your name, phone number, and email address when you submit a request or register as a partner.\n- Usage Data: information about how you access and use the service, such as your IP address, browser type, and pages visited.\n- Cookies: We use cookies to track activity on our service and hold certain information.",
            },
            dataUsage: {
                title: "How We Use Your Information",
                content: "We use the data we collect for various purposes:\n- To provide and maintain our service.\n- To manage your account and facilitate communication.\n- To notify you about changes to our service.\n- To analyze usage and improve our platform.\n- To connect your requests with the relevant partners.",
            },
            dataSharing: {
                title: "Sharing Your Information",
                content: "We may share your personal information in the following situations:\n- With Service Providers: To assist us in operating our service.\n- With Partners: When you submit a service request, your contact information is shared with the relevant partner to enable them to contact you.\n- For Legal Compliance: If required to do so by law.",
            },
            security: {
            ...
            contact: {
                title: "Contact Us",
                content: "If you have any questions about this Privacy Policy, you can contact us via our 'Contact Us' page.",
            },
        },
        termsOfUsePage: {
            title: "Terms of Use",
            ...
            agreement: {
                ...
                content: "By using the ONLY HELIO platform, you agree to be bound by these Terms of Use. If you disagree with any part of the terms, then you may not access the platform.",
            },
            serviceDescription: {
                title: "Service Description",
                content: "ONLY HELIO is an online platform specializing in showcasing real estate and related services (such as finishing and decoration) in New Heliopolis. We act as an intermediary between customers and service providers (partners).",
            },
            userAccounts: {
                title: "User and Partner Accounts",
                content: "Partners are responsible for maintaining the confidentiality of their account information. You must provide accurate and complete information upon registration. We reserve the right to suspend or terminate accounts that violate these terms.",
            },
            prohibited: {
                title: "Prohibited Activities",
                content: "You may not use the platform for any illegal or unauthorized purpose. This includes, but is not limited to, posting misleading or fraudulent content, violating intellectual property rights, or using the platform in a way that could damage it.",
            },
            intellectualProperty: {
                title: "Intellectual Property",
                content: "The platform and its original content, features, and functionality are owned by ONLY HELIO and are protected by international copyright and trademark laws.",
            },
            disclaimer: {
                title: "Disclaimer",
                content: "The service is provided 'as is'. We do not warrant the accuracy, completeness, or reliability of any information on the platform. You agree that your use of the platform is at your own risk.",
            },
            limitation: {
                title: "Limitation of Liability",
                content: "In no event shall ONLY HELIO be liable for any indirect, incidental, or special consequential damages arising out of or in connection with your use of the platform.",
            },
            governingLaw: {
                title: "Governing Law",
                content: "These Terms shall be governed and construed in accordance with the laws of the Arab Republic of Egypt.",
            },
            contact: {
                title: "Contact Us",
                content: "If you have any questions about these Terms of Use, you can contact us via our 'Contact Us' page.",
            },
        },
    }
};