        ...
        (key: string) => {
            if (!sortConfig || sortConfig.key !== key) {
                return React.createElement(
                    'span',
                    { className: 'w-4 h-4 ml-1 inline-block opacity-0 group-hover:opacity-50' },
                    React.createElement(ArrowUpIcon, null)
                );
            }
            return sortConfig.direction === 'ascending' ? (
                React.createElement(ArrowUpIcon, { className: 'w-4 h-4 ml-1 inline-block' })
            ) : (
                React.createElement(ArrowDownIcon, { className: 'w-4 h-4 ml-1 inline-block' })
            );
        },
        [sortConfig],
    );
